...
static const TCHAR    OurDllName[] = _T("IExample3.dll");
static const TCHAR    OurProgID[] = _T("IExample3.object");
static const TCHAR    TypeLibName[] = _T("IExample3.tlb");
static const TCHAR    ObjectDescription[] = _T("IExample3 COM component");
static const TCHAR    FileDlgTitle[] = _T("Locate IExample3.dll to de-register it");
